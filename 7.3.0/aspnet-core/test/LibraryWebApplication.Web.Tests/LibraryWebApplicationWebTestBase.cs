...
{
    public abstract class LibraryWebApplicationWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static LibraryWebApplicationWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(LibraryWebApplicationWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<LibraryWebApplicationDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<LibraryWebApplicationDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<LibraryWebApplicationDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<LibraryWebApplicationDbContext, Task<T>> func)
        {
            T result;
