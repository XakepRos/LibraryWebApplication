...
namespace LibraryWebApplication.Migrations
{
    ...
    [Migration("20220911103109_Modified-DeptarTable")]
    partial class ModifiedDeptarTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("LibraryWebApplication.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryWebApplication.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("LibraryWebApplication.Departments.Department", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("LibraryWebApplication.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("LibraryWebApplication.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("LibraryWebApplication.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("LibraryWebApplication.Authorization.Roles.Role", b =>
                {
                    b.HasOne("LibraryWebApplication.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("LibraryWebApplication.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("LibraryWebApplication.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
