...
namespace LibraryWebApplication.EntityFrameworkCore.Seed.Host
{
    public class DefaultLanguagesCreator
    {
        ...
        {
            var tenantId = LibraryWebApplicationConsts.MultiTenancyEnabled ? null : (int?)MultiTenancyConsts.DefaultTenantId;
        ...
        public DefaultLanguagesCreator(LibraryWebApplicationDbContext context)
        {
            _context = context;
        }
